    ...
    <div className="arts-container">
      <Container>
        ...
        <Row className="mt-3">
          <Col xs={12} md={3}>
            <div className="row-1__content">
              <img src={art9} alt="nft-1" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
          ...
          <Col xs={12} md={3}>
            <div className="row-2__content">
              <img src={art11} alt="nft-2" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
          ...
          <Col xs={12} md={3}>
            <div className="row-1__content">
              <img src={art12} alt="nft-3" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
          ...
          <Col xs={12} md={3}>
            <div className="row-1__content">
              <img src={art13} alt="nft-4" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
        ...
        <Row className="mt-3">
          <Col xs={12} md={3}>
            <div className="row-1__content">
              <img src={art14} alt="nft-1" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
          ...
          <Col xs={12} md={3}>
            <div className="row-2__content">
              <img src={art13} alt="nft-2" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
          ...
          <Col xs={12} md={3}>
            <div className="row-1__content">
              <img src={art16} alt="nft-3" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
          ...
          <Col xs={12} md={3}>
            <div className="row-1__content">
              <img src={art15} alt="nft-4" className="row-image__1" />
              <div className="row-text">
                <p>Desert king</p>
                <p>1MBT per night</p>
              </div>
